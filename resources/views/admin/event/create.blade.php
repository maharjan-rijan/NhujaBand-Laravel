                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="organizer" id="organizer" class="form-control" placeholder="Organized By">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="time" name="time" id="time" class="form-control" placeholder="Event Time">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
