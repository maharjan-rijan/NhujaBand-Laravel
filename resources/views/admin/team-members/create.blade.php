...
@section('title')- Team Member Create @endsection
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="band_role" id="band_role" class="form-control" placeholder="Position">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url"  name="facebookUrl" id="facebookUrl" class="form-control" placeholder="Facebook Url">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url"  name="instagramUrl" id="instagramUrl" class="form-control" placeholder="Instagram Url">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
